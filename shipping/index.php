...
// Retrieve staff details (including department) from the database
...
if ($result->num_rows > 0) {
    ...
    // Check if the staff is from the Shipping department
    if ($department !== 'Shipping') {
        // Output a minimal HTML page with SweetAlert2 and redirect
        ?>
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1" />
    <title>Shipping Department</title>
    ...
    <!-- SweetAlert2 (available if needed on this page) -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body>
    <div class="top">
