...
// Retrieve staff details from the database (including department)
$staff_ID = $_SESSION['staff_ID'];
$sql = "SELECT CONCAT(firstname, ' ', middlename, ' ', lastname) AS username, department 
        FROM staff 
        WHERE staff_ID = ?";
...
if ($result->num_rows > 0) {
    ...
    // Check if the staff is from the Production department
    if ($department !== 'Production') {
        // Output a minimal HTML page with SweetAlert2
        ?>
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
<head>
    ...
    <!-- SweetAlert2 (in case you need it elsewhere) -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
</head>
<body>
    <div class="top">
            ...
            <div class="table-div-content">
                <div class="content">
                    ...
                    if (isset($_GET['page'])) {
                        $page = $_GET['page'];
                        $allowed_pages = [
                            'marketing', 'archive', 'tracking', 'shipping',
                            'dashboard', 'accounting', 'monitoring', 'production'
                        ];
